...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, EIoU=True, SIoU=False, WIoU=False,
             ShapeIoU=False,
             hw=1, mpdiou=False, Inner=False, Focaleriou=False, d=0.00, u=0.95, ratio=0.6, eps=1e-7, scale=0.0):
    """
